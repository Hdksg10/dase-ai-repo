...
class ResdiaulBlock(nn.Module):
    def __init__(self, input_channels, output_channels, stride = 1, residual = "add", *args, **kwargs) -> None:
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(input_channels, mid_channels, kernel_size=1, stride=stride),
        ...
        self.conv3 = nn.Sequential(
            nn.Conv2d(mid_channels, output_channels, kernel_size=1),
...
class ResNet50BN(nn.Module):
    def __init__(self, num_blocks_list:list, residual = "add", *args, **kwargs) -> None:
        ...
        self.blocks = nn.Sequential(
            ResNetBlock(64, 256, num_blocks_list[0], residual=residual),
            ResNetBlock(256, 512, num_blocks_list[1], stride=2, residual=residual),
            ResNetBlock(512, 1024, num_blocks_list[2], stride=2, residual=residual),
            ResNetBlock(1024, 2048, num_blocks_list[3], stride=2, residual=residual)
        )
